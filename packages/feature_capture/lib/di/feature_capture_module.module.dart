...
import 'package:feature_capture/data/page_detection_repository_impl.dart'
    as _i921;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    gh.lazySingleton<_i684.SpellCheckDataSource>(
        () => _i684.SpellCheckDataSourceImpl());
    gh.factory<_i432.PageDetectionRepository>(
    ...
    gh.factory<_i267.RecognizeCapturedSpreadUseCase>(() =>
        _i267.RecognizeCapturedSpreadUseCase(
    ...
    gh.factoryParam<_i1073.MarkingBloc, _i851.MarkingArguments, dynamic>((
      ...
      _,
        ...
        _i1073.MarkingBloc(
          gh<_i267.RecognizeCapturedSpreadUseCase>(),
