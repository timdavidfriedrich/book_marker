...
import 'package:feature_capture/data/data_sources/spell_check_data_source.dart' as _i972;
import 'package:feature_capture/data/repositories/camera_repository_impl.dart' as _i629;
import 'package:feature_capture/data/repositories/page_detection_repository_impl.dart' as _i490;
import 'package:feature_capture/data/repositories/text_recognition_repository_impl.dart' as _i23;
import 'package:feature_capture/domain/repositories/camera_repository.dart' as _i946;
import 'package:feature_capture/domain/repositories/page_detection_repository.dart' as _i567;
import 'package:feature_capture/domain/repositories/text_recognition_repository.dart' as _i653;
import 'package:feature_capture/domain/use_cases/recognize_captured_page_use_case.dart' as _i204;
import 'package:feature_capture/domain/use_cases/recognize_captured_spread_use_case.dart' as _i431;
import 'package:feature_capture/domain/use_cases/save_quote_use_case.dart' as _i396;
import 'package:feature_capture/presentation/add_book/add_book_bloc.dart' as _i796;
import 'package:feature_capture/presentation/capture/camera_cubit.dart' as _i741;
...
import 'package:shared/presentation/navigation/routes.dart' as _i800;
...
class FeatureCapturePackageModule extends _i526.MicroPackageModule {
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    ...
    gh.factory<_i483.JpegEncoderDataSource>(() => const _i483.JpegEncoderDataSource());
    ...
    gh.lazySingleton<_i972.SpellCheckDataSource>(() => _i972.SpellCheckDataSourceImpl());
    gh.factory<_i796.AddBookBloc>(() => _i796.AddBookBloc(gh<_i748.BookRepository>()));
    gh.factory<_i396.SaveQuoteUseCase>(
      () => _i396.SaveQuoteUseCase(
    ...
    gh.factory<_i431.RecognizeCapturedSpreadUseCase>(
      () => _i431.RecognizeCapturedSpreadUseCase(gh<_i204.RecognizeCapturedPageUseCase>()),
    );
    gh.factoryParam<_i1073.MarkingBloc, _i800.Marking, dynamic>(
      (
        _route,
        _,
      ) => _i1073.MarkingBloc(
