...
import '../config/attachment_config.dart' as _iy2kv0ue;
...
abstract class RuntimeConfig
  ...
  factory RuntimeConfig({
    ...
    required _iy2kv0ue.AttachmentConfig attachments,
  ...
  factory RuntimeConfig.fromJson(Map<String, dynamic> jsonSerialization) {
    return RuntimeConfig(
      ...
      syncLimits: _it2ad2ly.Protocol().deserialize<_iq33rqo6.SyncLimits>(
        jsonSerialization['syncLimits'],
      ),
      attachments: _it2ad2ly.Protocol().deserialize<_iy2kv0ue.AttachmentConfig>(
  ...
  _iy2kv0ue.AttachmentConfig attachments;
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'attachments': attachments.toJsonForProtocol(),
...
class _RuntimeConfigImpl extends RuntimeConfig {
  ...
  RuntimeConfig copyWith({
    ...
    return RuntimeConfig(
      ...
      attachments: attachments ?? this.attachments.copyWith(),
