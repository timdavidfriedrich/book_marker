...
import 'package:shared/data/data_sources/settings_local_data_source.dart' as _i115;
import 'package:shared/data/data_sources/shelf_local_data_source.dart' as _i1026;
...
import 'package:shared/data/repositories/app_config_repository_impl.dart' as _i509;
...
import 'package:shared/data/repositories/entitlement_repository_impl.dart' as _i1011;
import 'package:shared/data/repositories/quote_repository_impl.dart' as _i943;
import 'package:shared/data/repositories/sample_data_repository_impl.dart' as _i136;
import 'package:shared/data/repositories/settings_repository_impl.dart' as _i921;
...
import 'package:shared/data/repositories/voice_note_repository_impl.dart' as _i908;
...
import 'package:shared/domain/repositories/sample_data_repository.dart' as _i124;
...
class SharedPackageModule extends _i526.MicroPackageModule {
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) async {
    ...
    gh.factory<_i315.BookLocalDataSource>(
      () => _i315.BookLocalDataSourceImpl(
        gh<_i50.AppDatabase>(),
        gh<_i807.CipherCodec>(),
      ),
    );
    gh.factory<_i541.AppConfigRepository>(
      () => _i509.AppConfigRepositoryImpl(
    ...
    gh.factory<_i748.BookRepository>(
      () => _i245.BookRepositoryImpl(
