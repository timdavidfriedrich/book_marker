...
--
-- Class AttachmentObject as table attachment_objects
--
...
--
-- Class SyncedBook as table books
--
CREATE TABLE "books" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    "owner_id" uuid NOT NULL,
...
--
-- Class Entitlement as table entitlements
--
CREATE TABLE "entitlements" (
    ...
    "backup_verifier" text,
    "backup_initialized_at" timestamp without time zone,
    "used_day" bigint NOT NULL DEFAULT 0,
    "used_week" bigint NOT NULL DEFAULT 0,
...
--
-- Class OcrUsage as table ocr_usage
--
...
--
-- Class SyncedQuote as table quotes
--
CREATE TABLE "quotes" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    "owner_id" uuid NOT NULL,
...
--
-- Class SyncedShelfBook as table shelf_books
--
...
--
-- Class SyncedShelf as table shelves
--
...
--
-- Class SyncedThemeQuote as table theme_quotes
--
...
--
-- Class SyncedTheme as table themes
--
CREATE TABLE "themes" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    "owner_id" uuid NOT NULL,
